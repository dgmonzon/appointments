...
public class AppointmentPersistenceImpl extends BasePersistenceImpl<Appointment>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_SURGERYANDAPPDATE =
		new FinderPath(AppointmentModelImpl.ENTITY_CACHE_ENABLED,
			AppointmentModelImpl.FINDER_CACHE_ENABLED, AppointmentImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findBySurgeryAndAppDate",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_SURGERYANDAPPDATE =
		new FinderPath(AppointmentModelImpl.ENTITY_CACHE_ENABLED,
			AppointmentModelImpl.FINDER_CACHE_ENABLED, AppointmentImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findBySurgeryAndAppDate",
			new String[] { Long.class.getName(), Date.class.getName() },
			AppointmentModelImpl.SURGERYID_COLUMN_BITMASK |
			AppointmentModelImpl.APPDATE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_SURGERYANDAPPDATE = new FinderPath(AppointmentModelImpl.ENTITY_CACHE_ENABLED,
			AppointmentModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countBySurgeryAndAppDate",
			new String[] { Long.class.getName(), Date.class.getName() });
	 ...
	 */
	@Override
	public List<Appointment> findBySurgeryAndAppDate(long surgeryId,
		Date appDate) throws SystemException {
		return findBySurgeryAndAppDate(surgeryId, appDate, QueryUtil.ALL_POS,
	...
	@Override
	public List<Appointment> findBySurgeryAndAppDate(long surgeryId,
		Date appDate, int start, int end) throws SystemException {
		return findBySurgeryAndAppDate(surgeryId, appDate, start, end, null);
	}
	...
	@Override
	public List<Appointment> findBySurgeryAndAppDate(long surgeryId,
		Date appDate, int start, int end, OrderByComparator orderByComparator)
		throws SystemException {
		boolean pagination = true;
		FinderPath finderPath = null;
		Object[] finderArgs = null;
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_SURGERYANDAPPDATE;
			finderArgs = new Object[] { surgeryId, appDate };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_SURGERYANDAPPDATE;
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_SURGERYANDAPPDATE_SURGERYID_2);

			boolean bindAppDate = false;

			if (appDate == null) {
				query.append(_FINDER_COLUMN_SURGERYANDAPPDATE_APPDATE_1);
			}
			else {
				bindAppDate = true;

				query.append(_FINDER_COLUMN_SURGERYANDAPPDATE_APPDATE_2);
			}
	 ...
	 */
	@Override
	public Appointment findBySurgeryAndAppDate_First(long surgeryId,
		Date appDate, OrderByComparator orderByComparator)
		throws NoSuchAppointmentException, SystemException {
		Appointment appointment = fetchBySurgeryAndAppDate_First(surgeryId,
	 ...
	 */
	@Override
	public Appointment fetchBySurgeryAndAppDate_First(long surgeryId,
		Date appDate, OrderByComparator orderByComparator)
		throws SystemException {
		List<Appointment> list = findBySurgeryAndAppDate(surgeryId, appDate, 0,
				1, orderByComparator);
	 ...
	 */
	@Override
	public Appointment findBySurgeryAndAppDate_Last(long surgeryId,
		Date appDate, OrderByComparator orderByComparator)
		throws NoSuchAppointmentException, SystemException {
		Appointment appointment = fetchBySurgeryAndAppDate_Last(surgeryId,
				appDate, orderByComparator);
	 ...
	 */
	@Override
	public Appointment fetchBySurgeryAndAppDate_Last(long surgeryId,
		Date appDate, OrderByComparator orderByComparator)
		throws SystemException {
		int count = countBySurgeryAndAppDate(surgeryId, appDate);

		if (count == 0) {
			return null;
		}

		List<Appointment> list = findBySurgeryAndAppDate(surgeryId, appDate,
	 ...
	 */
	@Override
	public Appointment[] findBySurgeryAndAppDate_PrevAndNext(long appId,
		long surgeryId, Date appDate, OrderByComparator orderByComparator)
		throws NoSuchAppointmentException, SystemException {
		Appointment appointment = findByPrimaryKey(appId);
		...
		try {
			...
			array[0] = getBySurgeryAndAppDate_PrevAndNext(session, appointment,
					surgeryId, appDate, orderByComparator, true);

			array[1] = appointment;

			array[2] = getBySurgeryAndAppDate_PrevAndNext(session, appointment,
					surgeryId, appDate, orderByComparator, false);
	...
	protected Appointment getBySurgeryAndAppDate_PrevAndNext(Session session,
		Appointment appointment, long surgeryId, Date appDate,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	 ...
	 */
	@Override
	public void removeBySurgeryAndAppDate(long surgeryId, Date appDate)
		throws SystemException {
		for (Appointment appointment : findBySurgeryAndAppDate(surgeryId,
				appDate, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(appointment);
		}
	}
	 ...
	 */
	@Override
	public int countBySurgeryAndAppDate(long surgeryId, Date appDate)
		throws SystemException {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_SURGERYANDAPPDATE;

		Object[] finderArgs = new Object[] { surgeryId, appDate };
	...
	private static final String _FINDER_COLUMN_SURGERYANDAPPDATE_SURGERYID_2 = "appointment.surgeryId = ? AND ";
	private static final String _FINDER_COLUMN_SURGERYANDAPPDATE_APPDATE_1 = "appointment.appDate IS NULL";
	private static final String _FINDER_COLUMN_SURGERYANDAPPDATE_APPDATE_2 = "appointment.appDate = ?";
	...
	public Appointment updateImpl(
		...
		if (isNew || !AppointmentModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((appointmentModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_SURGERYANDAPPDATE.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						appointmentModelImpl.getOriginalSurgeryId(),
						appointmentModelImpl.getOriginalAppDate()
					};

				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_SURGERYANDAPPDATE,
					args);
				FinderCacheUtil.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_SURGERYANDAPPDATE,
					args);
